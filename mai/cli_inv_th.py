...
Foot_input = [0.0,7.0,15.0,15.0,0.0,2.0,0.0,2.0,4.0,True]
...
class SendINVClient(Node):
    ...
    def send_request(self,hip_input,foot_input):
        # self.req.x = x
        # self.req.y = y
        # self.req.z = z
...
def main(args=None):
    ...
    response = send_inv_client.send_request(Hip_input, Foot_input)
    send_inv_client.get_logger().info(
